...
void VulkanExampleBase::updateTextOverlay()
{
	...
	amount_frame += 1;
	avg_frame +=  lastFPS;
	cc = avg_frame / amount_frame;
	std::cout << "amount fps " << amount_frame << std::endl;
	std::cout << "AVG fps " << cc << std::endl;
	std::cout << "-total fps " << avg_frame << std::endl;
